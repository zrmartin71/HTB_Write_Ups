...
I tried opening the "login.xlsx.enc" file in wireshark, but I get an error saying that the file is not in a format wireshark understands. To Google we go cause the guide for this is no help. 

![waiting_gif](https://github.com/user-attachments/assets/91cf1bf9-ce5d-4487-9ba0-5be9bbbdb72e)

So i need to use ghidra for this. According to the guide for the box, you need basic decompiler skills. So lets try putting the .exe file in ghidra and see what I get.
