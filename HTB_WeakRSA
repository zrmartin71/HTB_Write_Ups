# WeakRSA
## Introduction
This is a write-up for the Hack The Box "Weak RSA" room. Lets get Started!
...
Link to to learn more about RSA - https://www.encryptionconsulting.com/education-center/what-is-rsa
...
You will get two files. To view the key.pub file I downloaded libre office on to my kali vm. 
